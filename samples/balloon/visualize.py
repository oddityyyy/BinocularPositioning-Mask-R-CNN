...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    # print('jan')
    plt.savefig('D:/maskrcnn/Mask_RCNN-master/apple/val/2.jpg')     #apple改为calyx
    # print('feb')
...
#calyx.h5模型还未训练出来 这里也需要修改为calyx相关 "D:\maskrcnn\logs\calyx1\mask_rcnn_calyx_0300.h5"
config = balloon.appleConfig()                             #apple改为calyx
BALLOON_DIR = os.path.join(ROOT_DIR, "apple")              #apple改为calyx
...
def main(BALLOON_DIR, DEVICE, MODEL_DIR, config, ID, name):
    ...
    display_instances(image, r['rois'], r['masks'], r['class_ids'],
                      ['BG', 'apple','tw','th','tp'], r['scores'])          #apple改为calyx
