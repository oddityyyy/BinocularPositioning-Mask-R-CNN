...
class process(object):
    ...
    def locate(self):
        ...
        for i in range(len(self.Lrboxlist)):
            self.uD.append(
                round(BF/abs(self.Luboxlist[i][0]-self.Ruboxlist[i][0]), 2))
            self.dD.append(
                round(BF/abs(self.Ldboxlist[i][0]-self.Rdboxlist[i][0]), 2))
            self.lD.append(
                round(BF/abs(self.Llboxlist[i][0]-self.Rlboxlist[i][0]), 2))
            self.rD.append(
                round(BF/abs(self.Lrboxlist[i][0]-self.Rrboxlist[i][0]), 2))
