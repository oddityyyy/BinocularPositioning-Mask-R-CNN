...
left = cv2.imread('D:/maskrcnn/apple/val/val/Left.png')
left2 = left
right = cv2.imread('D:/maskrcnn/apple/val/val/Right.png')
right2 = right
...
print(list_average(sample.std4pos()))
# sample.point()
